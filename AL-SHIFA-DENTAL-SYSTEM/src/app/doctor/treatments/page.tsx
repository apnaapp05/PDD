...
export default function DoctorTreatmentManager() {
  ...
  const handleCreate = async () => {
    ...
    try {
      await DoctorAPI.createTreatment({
  ...
  const handleLinkInventory = async (treatmentId: number) => {
    ...
    try {
      await DoctorAPI.linkInventory(treatmentId, {
    ...
    <div className="p-6 max-w-6xl mx-auto space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-slate-500">Define services, set prices, and link to inventory for auto-deduction.</p>
        </div>
        ...
        <Card className="bg-indigo-50 border-indigo-100">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex gap-2 justify-end">
              ...
              <Button onClick={handleCreate} className="bg-indigo-600 hover:bg-indigo-700">Save Service</Button>
            </div>
          </CardContent>
        </Card>
      )}
          ...
          <Card key={t.id} className="relative group hover:shadow-md transition-shadow">
            ...
            <CardContent>
              <div className="mt-4 space-y-2 border-t pt-4 border-slate-100">
                ...
                {linkingId === t.id ? (
                  <div className="bg-indigo-50 p-2 rounded-md border border-indigo-100 space-y-2 animate-in fade-in">
                    <SimpleSelect 
                    ...
                    <div className="flex gap-2">
                      ...
                      />
                      <Button size="sm" className="h-8 bg-indigo-600" onClick={() => handleLinkInventory(t.id)}>Save</Button>
                  ...
                  <Button 
                    variant="outline" 
                    size="sm" 
                    className="w-full text-xs h-8 border-dashed text-slate-500 hover:text-indigo-600 hover:border-indigo-600"
